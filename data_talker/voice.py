...
Run this command to execute the code:
    poetry run python use_cases/data_chatter/voice.py
"""
...
def record_audio(
    ...
    silence_proportion_threshold (float): The proportion of total frames that are silent
    to consider the recording as predominantly silent.
